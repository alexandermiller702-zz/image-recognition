...
def load_images(test_data_dir, image_size = (300, 300)):
    ...
    if 'test' in test_data_dir:
        return images_data, sorted(labels), imagePaths
...
def independent_test_data(image_size=(300, 300)):
    # Load images
    images, labels, _index = load_images(test_data_dir="./data/test/", image_size=image_size)
...
if __name__ == '__main__':
    ...
    # Load images
    images, labels, _ = load_images(test_data_dir,image_size)
